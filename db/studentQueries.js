...
const getStudentsQueryParamChecker = function (req) {
    ...
    const addStudentQueryParams = function (req) {
      ...
      const addMeetingQueryParams = function(req) {
        ...
        if(req.method = "PUT") {putStudents(studentQueryParams, putStudentQueryBuilder)} else {
         ...
         sqlQuery = getStudentsQueryBuilder(studentQueryParams, moduleQueryParams, programQueryParams,);
         return sqlQuery;
...
const getStudentsByQueryParams = function (queryParams, getStudentsQueryParamChecker) {

   const sqlQuery = getStudentsQueryParamChecker(queryParams);
...
const postStudentsQueryParamChecker = function(req) {
    ...
    sqlQuery = postStudentQueryBuilder(studentQueryParams);
...
var sqlQuery = "INSERT INTO student (`studentNumber`,`firstName`,`lastName`,`DOB`,`admitTermID`,`email`,`currentLevel`,`startLevel`) VALUES ("
+ "'" + studentQueryParams.join("' ,'") + "')";

return sqlQuery;
}

const postStudents = function (queryParams, postStudentsQueryParamChecker) {

    sqlQuery = postStudentsQueryParamChecker(queryParams);
